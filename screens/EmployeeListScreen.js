...
class EmployeeListScreen extends Component {
  ...
  updateEmployee = (data) => {
    ...
    this.setState({ employee: this.state.employee.map(emp => (emp.id || emp._id) == (data.id || data._id) ? data : emp) });
       //optionaly reload data
       this.getData();
  }
  ...
  deleteEmployee = employeeId => {
    ...
    this.setState({ employee: this.state.employee.filter(emp => (emp.id || emp._id) !== employeeId) })
    //optionaly reload data
    this.getData();
  }
    ...
    return (
      <ScrollView>
        ...
        <View style={styles.container}>
          ...
          {employee.map((data, index) => <View key={data.id || data._id}
            ...
            <Text style={styles.listItem}>Age: {data.age}</Text>
            <Text style={styles.listItem}>Salary: {data.salary}</Text>
